...
//                "Халтуринская 17",
//                "hotel2",
//                "Этот семейный 4-звездочный отель находится в центре Мюнхена, всего в 200 метрах от станции городской электрички Изартор",
//                "",
//                4,
//                4366,
//                8.6,
//                hashMap));
//
//        hostelList.add(new HostelCard("Flemings Hotel München-Schwabing",
//                "Коломна",
//                "Пионерская 28",
//                "hotel3",
//                "Отель расположен в мюнхенском районе, Швабинг, всего в 300 метрах от станции метро Münchner Freiheit.",
//                "",
//                7,
//                1530,
//                7.7,
//                hashMap));
//
//        hostelList.add(new HostelCard("harry's home hotel & apartments",
//                "Москва",
//                "Минская 13",
//                "hotel4",
//                "Комплекс harry's home hotel & apartments расположен в городе Мюнхен, в 2,4 км от дворца Нимфенбург. К услугам гостей номера и апартаменты с кондиционером и бесплатный Wi-Fi на всей территории",
//                "",
//                2,
//                2900,
//                8.7,
